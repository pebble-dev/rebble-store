...
export default {
  ...
  methods: {
    get_data: function (routeParams) {
      ...
      this.$http.get(`${this.$store.state.backendUrl}/home/${this.type}?platform=${this.$store.state.userParameters.platform}&hardware=${this.$store.state.userParameters.hardware}&filter_hardware=true`).then(response => {
